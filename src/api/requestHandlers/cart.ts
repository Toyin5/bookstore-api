...
export const addToCartHandler = wrapAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const clearCartHandler = wrapAsync(async (req: Request, res: Response, next: NextFunction) => {
     const user = res.locals.user.user;
